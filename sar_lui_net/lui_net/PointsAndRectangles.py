...
class Rect:
    ...
    def __init__(self, pt1, width, height):
        """Initialize a rectangle from two points."""
        self.set_points(pt1, Point(pt1.x + width, pt1.y + height))

    def __init__(self, x, y, width, height):
        """Initialize a rectangle from two points."""
        self.set_points(Point(x, y), Point(x + width, y + height))
    ...
    def contains_rect(self, rect):
        return self.contains(Point(rect.left, rect.top)) and self.contains(Point(rect.right, rect.bottom))
